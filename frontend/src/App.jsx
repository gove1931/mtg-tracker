          ...
          <div className="mt-12">
            ...
            {prizeBoxCount && (
              <div style={{ marginTop: 10, padding: "8px 12px", background: "rgba(247,140,108,0.08)", borderRadius: 8, border: "1px solid rgba(247,140,108,0.2)" }}>
                <div style={{ fontSize: 10, color: "#888" }}>ジェム換算値（暫定）</div>
...
const styles = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .btn { background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; color: #ccc; cursor: pointer; font-size: 14px; padding: 10px 14px; transition: all 0.15s; }
  ...
  .prize-label { color: #888; font-size: 9px; text-align: center; line-height: 1.2; }
